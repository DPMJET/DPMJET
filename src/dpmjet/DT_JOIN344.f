      ...
      SUBROUTINE DT_JOIN344(Idx1,Idx2,Idx3,Irej)
 
C***********************************************************************
C This subroutine joins a aq-q and a q-aq chain to a third aq-q chain.          *
C     IDX1, IDX2 ,IDX3      DTEVT1 indices of chains to be joined           *
C This version dated 11.01.95 is written by S. Roesler.                *
C***********************************************************************
 
      IMPLICIT NONE
      INTEGER i , idd , idx , Idx1 , Idx2 , Idx3 , if1 , if2 , Irej , 
     &        irej1 , ist1 , ist2 , j , k , kch , mo
